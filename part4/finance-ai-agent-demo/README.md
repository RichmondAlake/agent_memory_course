...
This copy was imported into this course repository under `part4/finance-ai-agent-demo/`.
...
All commands below assume you are in the `part4/finance-ai-agent-demo/` directory.
